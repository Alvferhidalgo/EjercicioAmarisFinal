...
class ProductEntityTest {
    ...
    private final List<PriceEntity> PRICES = new ArrayList<>();
    private final List<PriceEntity> PRICES2 = new ArrayList<>();

    ProductEntity productEmpty = new ProductEntity();
    ProductEntity product = new ProductEntity(STRING_VALUE, PRICES, DATE, DATE,
            STRING_VALUE, LONG_VALUE, DATE);
