...
class ProductDtoTest {
    ...
    private final List<PriceDto> PRICES2 = new ArrayList<>();

    ProductDto productEmpty = new ProductDto();
    ProductDto product = new ProductDto(STRING_VALUE, PRICES, DATE, DATE, STRING_VALUE,
            LONG_VALUE, DATE);
