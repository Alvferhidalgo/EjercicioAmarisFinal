...
class PriceDtoTest {
    ...
    PriceDto priceSampleEmpty = new PriceDto();
    PriceDto priceSample = new
            PriceDto(STRING_VALUE, BRAND, PRODUCT, DATE, DATE, INTEGER_VALUE, INTEGER_VALUE, DOUBLE_VALUE, STRING_VALUE);
